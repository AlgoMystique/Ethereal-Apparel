...
import afterpay_logo from './afterpay_logo.png'
export const assets = {
    logo,
    hero_img,
    cart_icon,
...
export const products = [
    {
        ...
        description: "A lightweight, usually knitted, pullover shirt, close-fitting and with a round neckline and long sleeves, worn as an outer garment.",
        price: 100,
        image: [p_img1],
        category: "Women",
        subCategory: "Topwear",
